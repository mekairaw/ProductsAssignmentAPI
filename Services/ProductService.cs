...
namespace ProductsAssignmentAPI.Services
{
    public class ProductService : IProductService
    {
        ...
        public async Task<SaveProductResponse> UpdateAsync(int id, Product product)
        {
            ...
            {
                return new SaveProductResponse($"An error has ocurred while updating this product: {ex.Message}");
            }
        }
        ...
        public async Task<DeleteProductResponse> DeleteProductAsync(int id)
        {
            ...
            {
                return new DeleteProductResponse($"An error has ocurred while deleting this product: {ex.Message}");
            }
        }
    }
}
